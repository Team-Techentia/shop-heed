  ...
  return (
    <CommonLayout title="Cancellation and Refund" parent="home">
     <div className="extra-pages">
      <h1>Refund Policy</h1>
      <p>
        We at Shopheed hope that you fall in love at first sight with our stylish clothes! But in case you're unhappy with anything you have received from our store, we'll be there to help you every step of the way because we can’t see our customers unhappy.
      </p>
      <p>
        Shopheed offers a simple 'NO QUESTIONS ASKED' 3 days return or exchange policy to our customers. The customer can raise a request anytime within 3 days of delivery.
      </p>
      <p>
        NOTE: Shopheed provides free return pick-ups for customers to have a hassle-free shopping as well as return experience. In case there is more than one product for return, the customer shall be charged Rs.100 for every pick after the first free one.
      </p>
      ...
      <ul>
        <li>The return or exchange process may take up to 7-15 working days depending upon stock and request raised.</li>
        <li>Products bought on SALE price will not be exchanged or returned.</li>
        <li>Exchanges are valid only one time.</li>
        <li>Items are eligible for returns or exchanges only if they are unused with original tags.</li>
        <li>We are only reachable through mails for raising issues and inquiries regarding returns and exchanges.</li>
      </ul>

      <p>We wish you a happy and hassle-free shopping!</p>
    </div>
    </CommonLayout>
  );
};
